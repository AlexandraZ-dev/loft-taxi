  ...
  return (
    ...
    <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            fill="#FDBF5A"/>
      <path d="M5.43872 5.48047L7.4804 7.52215" stroke="#FDBF5A" stroke-width="2"/>
      ...
      <path d="M24.3652 10.9192L22.3235 12.9609" stroke="#FDBF5A" stroke-width="2"/>
      <path d="M28.0049 7.03687L25.9632 9.07855" stroke="#FDBF5A" stroke-width="2"/>
      <path d="M9.2207 9.2207L11.2624 11.2624" stroke="#FDBF5A" stroke-width="2"/>
      <path d="M13.3457 13.3457L15.3874 15.3874" stroke="#FDBF5A" stroke-width="2"/>
      <path d="M20.7256 14.8015L18.6839 16.8432" stroke="#FDBF5A" stroke-width="2"/>
    </svg>
